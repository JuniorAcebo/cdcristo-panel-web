...
@section('title', 'Gestión de Odontologos')
...
@section('content')
    ...
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 mt-4">
            <div>
                <h1 class="h3 mb-0 text-gray-800"><i class="bi bi-people-fill me-2"></i>Gestión de Odontologos</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('panel') }}">Inicio</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Odontologos</li>
                    </ol>
                </nav>
            </div>
            <a href="{{ route('odontologo.create') }}" class="btn btn-primary">
                <i class="bi bi-plus-lg me-1"></i> Nuevo Odontologo
            </a>
        </div>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-light">
                <h5 class="mb-0"><i class="bi bi-table me-2"></i>Registro de Odontologos</h5>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="odontologos-table" class="table table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th>CI</th>
                                <th>Odontologo</th>
                        ...
                        <tbody>
                            @foreach ($odontologos as $odontologo)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('odontologo.edit', $odontologo->id) }}"
                    ...
                    @foreach ($odontologos as $odontologo)
                        <div class="modal fade" id="deleteModal{{ $odontologo->id }}" tabindex="-1" aria-hidden="true">
